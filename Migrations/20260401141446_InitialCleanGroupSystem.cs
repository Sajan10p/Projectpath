...
{
    /// <inheritdoc />
    public partial class InitialCleanGroupSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    TutorNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentGroups_AspNetUsers_LeaderId",
                        column: x => x.LeaderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitedByStudentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupInvites_StudentGroups_StudentGroupId",
                        column: x => x.StudentGroupId,
                        principalTable: "StudentGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsIndividualFeedback = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProgressUpdates_Assignments_AssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupInvites_InvitedByStudentId",
                table: "GroupInvites",
                column: "InvitedByStudentId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupInvites_InvitedStudentId",
                table: "GroupInvites",
                column: "InvitedStudentId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupInvites_StudentGroupId",
                table: "GroupInvites",
                column: "StudentGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressUpdates_AssignmentId",
                table: "ProgressUpdates",
                column: "AssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgressUpdates_StudentId",
                table: "ProgressUpdates",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgressUpdates_TutorId",
                table: "ProgressUpdates",
                column: "TutorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGroups_LeaderId",
                table: "StudentGroups",
                column: "LeaderId");
